...
int main() {
    Mahasiswa *m[2];
    m[0] = new Mahasiswa("Mahasiswa Aktif", "Sophie", 19, "Teknologi Informasi", "Informatika dan Pariwisata");
    m[1] = new Alumni("Alumni", "Kiano", 24, "Sistem Informasi", "Informatika dan Pariwisata", 2020, "Data Analyst");
